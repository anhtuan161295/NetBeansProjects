...
import www.aptech.in.TestSessionBeanLocal;
...
public class CalculatorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        float a = Float.parseFloat(request.getParameter("numberA"));
        float b = Float.parseFloat(request.getParameter("numberB"));
        float result = testSessionBean.add(a, b);
