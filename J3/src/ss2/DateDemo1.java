 ...
 * @author QQ
 */
public class DateDemo1 extends javax.swing.JFrame {

    String str;
    String[] strDay = new String[]{"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"};
    ...
    public void getDate() {
        ...
        //Giờ VN mình xài là dương lịch, tên tiếng anh là gregorian calendar
        ...
        //Đặt ngày tháng năm cho đối tượng calendar dựa trên slider
        Calendar c = new GregorianCalendar(year, month - 1, day); // Lấy lịch theo giờ, vùng hiện tại
        //Lấy giá trị ngày trong tuần theo dạng Int
        int dayOfWeek = c.get(Calendar.DAY_OF_WEEK);
        //Calendar.DAY_OF_WEEK nó sẽ trả về số từ 1-7, với 1 là Sunday, 7 là Saturday
        //Trong khi mảng str ở trên 0 là Sunday, 6 là Saturday
        //Nên phải trừ 1 đi cho đúng với mảng str
        str = strDay[dayOfWeek - 1] + ", " + day + "/" + month + "/" + year;
        //Hiển thị lên label
        lblTextarea.setText(str);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DateDemo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
